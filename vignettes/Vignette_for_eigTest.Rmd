...
full_mat = full_samples[[1]]; print(dim(full_mat))
full_cov = full_samples[[2]]; print(dim(full_cov))
...
part_mat = part_samples[[1]]; print(dim(part_mat))
part_cov = part_samples[[2]]; print(dim(part_cov))
```
...
commutatorTest(mat.arr = full_mat[1,1,1,,,],  # sample matrices
               cn = sqrt(100),                # convergence rate
               cov.arr = full_cov[1,1,1,,,],  # covariance matrices
               param.out = TRUE)              # return parameters

## Log-likelihood ratio test
projTest(A = part_mat[1,1,1,,,],        # sample matrices
         cn = sqrt(100),                # convergence rate
         cov.arr = part_cov[1,1,1,,,],  # covariance matrices
         param.out = TRUE)              # return parameters
```
