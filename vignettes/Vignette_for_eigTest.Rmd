...
cat(paste('\tMatrix dimension:', paste0(dim(eg_full$mu.bar), collapse = 'x'), '\n'))
cat(paste('\tCovariance dimension:', paste0(dim(eg_full$cov.bar), collapse = 'x'), '\n'))

cat('Examples from part_samples:\n')
cat(paste('\tMatrix dimension:', paste0(dim(eg_part$mu.bar), collapse = 'x'), '\n'))
cat(paste('\tCovariance dimension:', paste0(dim(eg_part$cov.bar), collapse = 'x'), '\n'))
```
